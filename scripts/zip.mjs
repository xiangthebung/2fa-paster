 ...
 *
 * The Chrome Web Store wants a zip. Node already ships deflate and a
 * store-format zip is a few dozen lines, so there is no dependency and no
 * shelling out to a `zip` binary that a stock Windows machine does not have.
 *
